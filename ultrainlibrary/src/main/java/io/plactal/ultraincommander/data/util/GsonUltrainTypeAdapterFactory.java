package io.plactal.ultraincommander.data.util;
...
import io.plactal.ultraincommander.data.remote.model.types.TypeAccountName;
import io.plactal.ultraincommander.data.remote.model.types.TypeActionName;
import io.plactal.ultraincommander.data.remote.model.types.TypeAsset;
import io.plactal.ultraincommander.data.remote.model.types.TypeName;
import io.plactal.ultraincommander.data.remote.model.types.TypePermissionName;
import io.plactal.ultraincommander.data.remote.model.types.TypeScopeName;

/**
 * Created by swapnibble on 2018-04-04.
 */

public class GsonUltrainTypeAdapterFactory implements TypeAdapterFactory {
