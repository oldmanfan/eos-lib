...
import io.plactal.ultraincommander.data.remote.model.api.GetRequiredKeys;
import io.plactal.ultraincommander.data.remote.model.api.GetTableRequest;
import io.plactal.ultraincommander.data.remote.model.chain.Action;
import io.plactal.ultraincommander.data.remote.model.chain.PackedTransaction;
import io.plactal.ultraincommander.data.remote.model.chain.SignedTransaction;
import io.plactal.ultraincommander.data.remote.model.types.TypeActionName;
import io.plactal.ultraincommander.data.remote.model.types.TypeChainId;
import io.plactal.ultraincommander.rpc.service.Generator;
import io.plactal.ultraincommander.rpc.service.RpcService;

import static io.plactal.ultraincommander.util.Consts.TX_EXPIRATION_IN_MILSEC;
...
public class Rpc {
    ...
    public String pushTransaction(String code, String action, String account, String privateKey, Map<String, Object> args) {
        ...
        List<UltrainPublicKey> ultrainPublicKeys = getKeys(requiredKeys);
        ...
        for (UltrainPublicKey pubKey : ultrainPublicKeys) {
