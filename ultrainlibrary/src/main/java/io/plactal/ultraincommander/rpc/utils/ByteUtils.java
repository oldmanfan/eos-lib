package io.plactal.ultraincommander.rpc.utils;
...
import io.plactal.ultraincommander.rpc.exception.EException;
...
//				.putLong(Long.parseLong(amount));
    ...
    public static byte[] writerKey(String key) {
        io.plactal.ultraincommander.rpc.utils.ByteBuffer bf = new io.plactal.ultraincommander.rpc.utils.ByteBuffer();
