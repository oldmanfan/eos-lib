package com.limite.ultrainlibsimple;
...
import io.plactal.ultraincommander.rpc.Rpc;
...
//        final Rpc rpc = new Rpc("https://ultrainio.ultrain.info");
        ...
        threadPoolExecutor.execute(new Runnable() {
            ...
            public void run() {
                ...
                String ultrainChainInfo =  rpc.getChainInfo();
                Log.d(TAG, "ChainInfo: " + ultrainChainInfo);
...
//        System.out.println();
//        System.out.println("GetChainInfo: " + gson.toJson(ultrainChainInfo));
//
//        UltrainChainInfo info = new Gson().fromJson(ultrainChainInfo, UltrainChainInfo.class);
...
//
//        String balance = rpc.getCurrencyBalance("smallred1111", "ultrainio.token", "TOK");
//        System.out.println();
...
//        args.put("memo", "阿卡丽");
//        String jsonToBinResponse = rpc.abiJsonToBin("ultrainio.token", "transfer", args);
//        System.out.println();
...
//                args2.put("memo", "阿卡丽2");
//
//                String txnResponse = rpc.pushTransaction("ultrainio.token", "transfer", "smallred1111", SAMPLE_PRIV_KEY_FOR_TEST, args2);
//                System.out.println();
